...
public:
	...
	KPServer web{"web-server", "OPEnSampler", "password"};
	...
	void setup() override {
		...
		sm.registerState(StateClean(), StateName::clean, 3);
		...
		logging.delay(5000, [this]() {
			logToFile("logs.txt", fileLoader);
		});
